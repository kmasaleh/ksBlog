...
export class ModalDemoComponent implements OnInit {
  ...
  loadAssets(){
      this.loadAssetFile('/app/componenets/modal-demo/modal-demo.component.ts').subscribe(data =>this.modal_demo_ts=data );
      this.loadAssetFile('/app/componenets/modal-demo/modal-demo.component.css').subscribe(data =>this.modal_demo_css =data);
      this.loadAssetFile('/app/componenets/modal-demo/modal-demo.component.html').subscribe(data =>this.modal_demo_html=data );
      this.loadAssetFile('/app/componenets/modal-demo/info.ts').subscribe(data =>this.info_ts =data);
      this.loadAssetFile('/app/componenets/modal-demo/simple.ts').subscribe(data =>this.simple_ts =data);
      this.loadAssetFile('/app/componenets/modal-demo/random-pictures.ts').subscribe(data =>this.random_pictures_ts=data );
  }
  OnInfoModal(){
